 ...
 * File: numbers_gui
 *
 * This is the implementation file for the class NumberTile
...
void NumberTile::set_value(int new_value)
{
    value_ = new_value;
}

Coords NumberTile::get_coords()
{
    return coords_;
}
...
{
    return coords.first >= 0 and coords.first < board_->get_grid_size() and
           coords.second >= 0 and coords.second < board_->get_grid_size();
}
